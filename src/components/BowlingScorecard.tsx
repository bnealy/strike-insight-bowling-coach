...
const BowlingScorecard = () => {
  ...
  const enterPins = (pins) => {
    ...
    // Determine if we're editing an existing frame or entering new data
    ...
    // If we're editing, clear the frame and recalculate from this point
    if (editingFrame !== null && editingBall !== null) {
      // Clear this ball and all subsequent balls in the frame
      if (targetFrame === 9) {
        // 10th frame
      ...
      // Clear all frames after this one
    ...
    // Validate input based on target frame
    if (targetFrame < 9) {
      // Regular frames (1-9)
      if (targetBall === 0) {
        ...
        if (editingFrame !== null) {
          // If editing, stay in edit mode but move to next ball if not a strike
          if (pins === 10) {
            setEditingFrame(null);
            setEditingBall(null);
            // Update current position for new input
            if (targetFrame < 9) {
  ...
  const handleBallClick = (frameIndex, ballIndex) => {
    // Always allow editing of any thrown ball, regardless of game completion status
    ...
    // If game is complete, allow editing any ball that has been thrown
                    ...
                    <>
                      <div 
                        style={{
                          ...styles.ballTenth, 
                          borderRight: '1px solid #333',
                          ...(editingFrame === frameIndex && editingBall === 0 ? styles.ballEditing : {}),
                          ...(frames[frameIndex].balls[0] !== null || (frameIndex === currentFrame && 0 === currentBall) || gameComplete ? styles.ballClickable : {})
                        }}
                        onClick={() => handleBallClick(frameIndex, 0)}
                        onMouseEnter={(e) => {
                          if (frames[frameIndex].balls[0] !== null || (frameIndex === currentFrame && 0 === currentBall) || gameComplete) {
                            e.currentTarget.style.backgroundColor = '#e9ecef';
                          }
                        }}
                        onMouseLeave={(e) => {
                          if (editingFrame === frameIndex && editingBall === 0) {
                            e.currentTarget.style.backgroundColor = '#fff3cd';
                          } else if (frames[frameIndex].balls[0] !== null || (frameIndex === currentFrame && 0 === currentBall) || gameComplete) {
                      ...
                      <div 
                        style={{
                          ...styles.ballTenth, 
                          borderRight: '1px solid #333',
                          ...(editingFrame === frameIndex && editingBall === 1 ? styles.ballEditing : {}),
                          ...(frames[frameIndex].balls[1] !== null || (frameIndex === currentFrame && 1 === currentBall) || gameComplete ? styles.ballClickable : {})
                        }}
                        onClick={() => handleBallClick(frameIndex, 1)}
                        onMouseEnter={(e) => {
                          if (frames[frameIndex].balls[1] !== null || (frameIndex === currentFrame && 1 === currentBall) || gameComplete) {
                            e.currentTarget.style.backgroundColor = '#e9ecef';
                          }
                        }}
                        onMouseLeave={(e) => {
                          if (editingFrame === frameIndex && editingBall === 1) {
                            e.currentTarget.style.backgroundColor = '#fff3cd';
                          } else if (frames[frameIndex].balls[1] !== null || (frameIndex === currentFrame && 1 === currentBall) || gameComplete) {
                            e.currentTarget.style.backgroundColor = '#f8f9fa';
                          } else {
                            e.currentTarget.style.backgroundColor = 'white';
                          }
                      ...
                      <div 
                        style={{
                          ...styles.ballTenth, 
                          borderRight: 'none',
                          ...(editingFrame === frameIndex && editingBall === 2 ? styles.ballEditing : {}),
                          ...(frames[frameIndex].balls[2] !== null || (frameIndex === currentFrame && 2 === currentBall) || gameComplete ? styles.ballClickable : {})
                        }}
                        onClick={() => handleBallClick(frameIndex, 2)}
                        onMouseEnter={(e) => {
                          if (frames[frameIndex].balls[2] !== null || (frameIndex === currentFrame && 2 === currentBall) || gameComplete) {
                            e.currentTarget.style.backgroundColor = '#e9ecef';
                          }
                        }}
                        onMouseLeave={(e) => {
                          if (editingFrame === frameIndex && editingBall === 2) {
                            e.currentTarget.style.backgroundColor = '#fff3cd';
                          } else if (frames[frameIndex].balls[2] !== null || (frameIndex === currentFrame && 2 === currentBall) || gameComplete) {
                            e.currentTarget.style.backgroundColor = '#f8f9fa';
                          } else {
                            e.currentTarget.style.backgroundColor = 'white';
                          }
...
const BowlingScorecard = () => {
  ...
  const isSpare = (frameIndex) => {
    if (frameIndex === 9) return false; // 10th frame spares handled differently
    return !isStrike(frameIndex) && frames[frameIndex].balls[0] + frames[frameIndex].balls[1] === 10;
  };
  ...
  const handleBallClick = (frameIndex, ballIndex) => {
    // Don't allow editing if the ball hasn't been thrown yet and we're not at this position
    if (frames[frameIndex].balls[ballIndex] === null && !(frameIndex === currentFrame && ballIndex === currentBall)) {
      return;
    }
    setEditingFrame(frameIndex);
    setEditingBall(ballIndex);
    ...
    for (let i = 0; i <= maxPins; i++) {
      buttons.push(
        <Button 
          key={i}
          onClick={() => enterPins(i)}
          className="w-12 h-12 rounded-full bg-green-500 hover:bg-green-600 text-white font-bold text-lg"
        >
          {i}
        </Button>
      );
      ...
      <div style={styles.scorecard}>
        <div style={styles.framesContainer}>
          {frames.map((frame, frameIndex) => {
            ...
            return (
              <div key={frameIndex} style={frameStyle}>
                <div style={styles.frameNumber}>{frameIndex + 1}</div>
                {frameIndex === 9 ? (
                  // 10th frame - 3 balls
                  <>
                    <div style={styles.ballsRowTenth}>
                      <div
                        style={{
                          ...styles.ballTenth,
                          ...(editingFrame === frameIndex && editingBall === 0 ? styles.ballEditing : {}),
                          ...(frames[frameIndex].balls[0] !== null || (frameIndex === currentFrame && 0 === currentBall) ? styles.ballClickable : {})
                        }}
                        onClick={() => handleBallClick(frameIndex, 0)}
                        onMouseEnter={(e) => {
                          if (frames[frameIndex].balls[0] !== null || (frameIndex === currentFrame && 0 === currentBall)) {
                            e.currentTarget.style.backgroundColor = '#e9ecef';
                          }
                        }}
                        onMouseLeave={(e) => {
                          if (editingFrame === frameIndex && editingBall === 0) {
                            e.currentTarget.style.backgroundColor = '#fff3cd';
                          } else if (frames[frameIndex].balls[0] !== null || (frameIndex === currentFrame && 0 === currentBall)) {
                            e.currentTarget.style.backgroundColor = '#f8f9fa';
                          } else {
                            e.currentTarget.style.backgroundColor = 'white';
                          }
                      ...
                      <div
                        style={{
                          ...styles.ballTenth,
                          ...(editingFrame === frameIndex && editingBall === 1 ? styles.ballEditing : {}),
                          ...(frames[frameIndex].balls[1] !== null || (frameIndex === currentFrame && 1 === currentBall) ? styles.ballClickable : {})
                        }}
                        onClick={() => handleBallClick(frameIndex, 1)}
                        onMouseEnter={(e) => {
                          if (frames[frameIndex].balls[1] !== null || (frameIndex === currentFrame && 1 === currentBall)) {
                            e.currentTarget.style.backgroundColor = '#e9ecef';
                          }
                        }}
                        onMouseLeave={(e) => {
                          if (editingFrame === frameIndex && editingBall === 1) {
                            e.currentTarget.style.backgroundColor = '#fff3cd';
                          } else if (frames[frameIndex].balls[1] !== null || (frameIndex === currentFrame && 1 === currentBall)) {
                            e.currentTarget.style.backgroundColor = '#f8f9fa';
                          } else {
                            e.currentTarget.style.backgroundColor = 'white';
                          }
                      ...
                      <div
                        style={{
                          ...styles.ballTenth,
                          ...(editingFrame === frameIndex && editingBall === 2 ? styles.ballEditing : {}),
                          ...(frames[frameIndex].balls[2] !== null || (frameIndex === currentFrame && 2 === currentBall) ? styles.ballClickable : {})
                        }}
                        onClick={() => handleBallClick(frameIndex, 2)}
                        onMouseEnter={(e) => {
                          if (frames[frameIndex].balls[2] !== null || (frameIndex === currentFrame && 2 === currentBall)) {
                            e.currentTarget.style.backgroundColor = '#e9ecef';
                          }
                        }}
                        onMouseLeave={(e) => {
                          if (editingFrame === frameIndex && editingBall === 2) {
                            e.currentTarget.style.backgroundColor = '#fff3cd';
                          } else if (frames[frameIndex].balls[2] !== null || (frameIndex === currentFrame && 2 === currentBall)) {
                            e.currentTarget.style.backgroundColor = '#f8f9fa';
                          } else {
                            e.currentTarget.style.backgroundColor = 'white';
                          }
        ...
        <div style={styles.totalScore}>Total Score: {totalScore}</div>
      </div>
      {gameComplete && (
        <div style={styles.gameComplete}>
          🎉 Game Complete! Final Score: {totalScore}
        ...
        <>
          <div style={styles.controls}>
            ...
            {editingFrame !== null && editingBall !== null && (
              <Button
                onClick={cancelEdit}
                className="ml-4 bg-gray-500 hover:bg-gray-600 text-white px-8 py-3 rounded-full font-medium"
              >
                Cancel Edit
              </Button>
            )}
